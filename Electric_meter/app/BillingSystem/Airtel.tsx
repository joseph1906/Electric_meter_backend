...
export default function Airtel() { 
    ...
    if (input && input.length === 10) {
        ...
        setLastPayment({ 
            ...
            amount: amount, 
            units,
            phoneNumber: input  // ← ADD THIS LINE
        });
        router.push("/BillingSystem/Printable");
    } else {
        alert("Please enter a valid Airtel number");
    }
}
    ...
    return (
        <ScrollView style={styles.scrollContainer}>
            ...
            <View style={styles.MainContainer}>
                <Text style={styles.MainTitle}>Airtel Mobile Number</Text>

                <Text style={styles.amountText}>Amount: UGX {amount.toLocaleString()}</Text>

                <Text style={styles.MainText}>
                    Please, enter your airtel number
                </Text>
                ...
                <Text style={styles.MainText}>
                    Please, enter your airtel money password
                </Text>
